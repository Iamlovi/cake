    ...
    (() => {
            ...
            for (let t = 0, n = i.length; t < n; t += 1) {
              ...
              void 0 !== r &&
                ...
                (O(e[n]) && O(s[n])
                  ...
                  : !O(e[n]) && O(s[n])
                  ? ((e[n] = {}),
                    s[n].__swiper__ ? (e[n] = s[n]) : P(e[n], s[n]))
                  : (e[n] = s[n]));
            }
          }
        }
        ...
        slideTo: function (e, t, i, s, n) {
          ...
          if (a.cssMode) {
            ...
            if (0 === t) {
              ...
              if (!r.support.smoothScroll)
                return (
                  _({ swiper: r, targetPosition: i, side: e ? "left" : "top" }),
                  !0
                );
      ...
      const R = {
        loopCreate: function () {
          ...
          for (let e = o.length - 1; e >= 0; e -= 1)
            n.prepend(I(o[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
        },
        loopFix: function () {
          const e = this;
      ...
      const ne = {
        setBreakpoint: function () {
          ...
          p && i && e.changeDirection(), P(e.params, l);
        ...
        i({
          ...
          s("click", (e, i) => {
            const { $nextEl: s, $prevEl: r } = t.navigation,
              o = i.target;
            if (t.params.navigation.hideOnClick && !I(o).is(r) && !I(o).is(s)) {
              if (
                t.pagination &&
                t.params.pagination &&
            ...
            (i ? t.slides.find(i) : t.slides).transition(e),
              (function (e) {
                ...
                if (t.params.virtualTranslate && 0 !== i) {
                  let e,
                    i = !1;
                  (e = n ? (s ? r.find(s) : r) : s ? r.eq(o).find(s) : r.eq(o)),
                    e.transitionEnd(() => {
                      if (i) return;
      ...
      window.addEventListener("load", function (e) {
        !(function () {
          ye();
          let e = new ue(".confectioners-slider", {
              modules: [he, me],
              grabCursor: !0,
              slidesPerView: 1,
              spaceBetween: 30,
              ...
              loop: !0,
              pagination: {
                el: ".confectioners__pagination",
                clickable: !0,
                type: "bullets",
              },
              navigation: {
                nextEl: ".confectioners__next",
                prevEl: ".confectioners__prev",
              },
            }),
            t = new ue(".confectioners-about", {
              modules: [ve],
              effect: "fade",
              observer: !0,
              observeParents: !0,
          ...
          const s = (s) => {
            e.slideTo(s), t.slideTo(s), i.slideTo(s);
          };
          e.on("slideChange", () => s(e.activeIndex)),
            t.on("slideChange", () => s(t.activeIndex)),
            i.on("slideChange", () => s(i.activeIndex));
        })();
      });
      class be {
        constructor(e) {
      ...
      var Re = function (e, t, i, s) {
          void 0 === i && (i = 0);
          var n = je(e).attr("data-lg-size") || s;
          if (n) {
            var r = n.split(",");
            if (r[1])
        ...
        st = (function () {
          ...
          return (
            ...
            (e.prototype.getDummyImageContent = function (e, t, i) {
              var s;
              if ((this.settings.dynamic || (s = je(this.items).eq(t)), s)) {
                var n = void 0;
                if (
            ...
            (e.prototype.loadContent = function (e, t) {
              ...
              if (
                ...
                if (m) {
                  ...
                  S = Ze(r, x || "", g, this.settings.strings.playVideo, h);
                  n.prepend(S);
                } else if (h) {
              ...
              this.settings.enableDrag &&
                ...
                je(window).on("mouseup.lg.global" + this.lgId, function (r) {
                  if (e.lgOpened) {
                    var o = je(r.target);
                    n
                      ? ((n = !1), e.touchEnd(i, t, r), e.LGel.trigger(De))
                      : e.isPosterElement(o) && e.LGel.trigger($e),
                      s &&
                        ((s = !1),
      ...
      rt.length &&
        ...
        document.addEventListener("DOMContentLoaded", () => {
          const e = document.querySelector(".tabs__navigation"),
            t = e.querySelector("._tab-active");
          if (!t) return;
          const i = e.getBoundingClientRect(),
            s = t.getBoundingClientRect(),
            n = s.left - i.left + (s.width - i.width) / 2;
          e.scrollLeft = n;
        }),
            ...
            function i(e) {
              ...
              var i = "+7 (___) ___ ____",
                ...
                o = i.replace(/[_\d]/g, function (e) {
                  return s < r.length ? r.charAt(s++) || n.charAt(s) : e;
                });
              -1 != (s = o.indexOf("_")) &&
      ...
      const ot = document.querySelector(".main-block__cherry");
      ot.addEventListener("animationend", () => {
        ot.style.willChange = "auto";
      }),
        (window.FLS = !0),
        (function (e) {
          let t = new Image();
            ...
            (function () {
              ...
              async function a(e, t) {
                if (!t.classList.contains("rating_sending")) {
                  ...
                  if (e.ok) {
                    (await e.json()).newRating;
                    r(), t.classList.remove("rating_sending");
